...
ALTER TABLE winzip_ipm.activation_activation_id_seq OWNER TO itadmin;
...
ALTER TABLE winzip_ipm.regcode_regcode_id_seq OWNER TO itadmin;
...
ALTER TABLE winzip_ipm.request_request_id_seq OWNER TO itadmin;
